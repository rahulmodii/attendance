            ...
            <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
                <thead>
                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                        <th class="text-center min-w-150px">Mobile</th>
                        <th class="text-center min-w-150px">Selfie</th>
                        <th class="text-center pe-3 min-w-100px">Date</th>
                        <th class="text-center pe-3 min-w-150px">Time</th>
                ...
                <tbody class="fw-bold text-gray-600">
                    @foreach ($data as $value)
                        <tr>
                            ...
                            <th class="text-center min-w-150px"><a
                                    href="{{ asset('/storage/' . $value->image) ?? '' }}">image</a></th>
                            <td class="text-center">
                                {{ \Carbon\Carbon::parse($value->created_at)->format('d-m-Y') ?? '' }}</td>
                            <td class="text-center">
                                {{ \Carbon\Carbon::parse($value->created_at)->format('h:i:s') ?? '' }}</td>
                            <td class="text-center">
                                {{ $value->time ?? '' }} min</td>
                            <td class="text-center">
                                @if ($value->type)
