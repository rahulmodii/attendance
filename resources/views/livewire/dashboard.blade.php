                    ...
                    <div class="card card-flush h-xl-100">
                        <div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px"
                            ...
                            <h3 class="card-title align-items-start flex-column text-white pt-15"> <span
                                    class="fw-bold fs-2x mb-3">Your Attendance</span>
                                <div class="fs-4 text-white">
                                    <span class="">Employee Name: {{ $newData->name ?? '' }}</span><br/>
                                ...
                                <div class="row g-3 g-lg-6">
                                    <div class="col-6">
                                        <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                            ...
                                            <div class="m-0"> <span
                                                    class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{ $newData->totalMinute ?? '' }}</span>
                                        ...
                                        <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                            ...
                                            <div class="m-0">
                                                <span
                                                    ...
                                                    @php
                                                        $timeFormatted = \Carbon\CarbonInterval::minutes($newData->totalMinute)
                                                            ->cascade()
                                                            ->forHumans([
                                    ...
                                    <div class="col-6">
                                        <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                            ...
                                            <div class="m-0"> <span
                                                    class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{ $newData->first_in_time ?? '' }}</span>
                                    ...
                                    <div class="col-6">
                                        <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                            ...
                                            <div class="m-0"> <span
                                                    class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{ $newData->first_out_time ?? '' }}</span>
